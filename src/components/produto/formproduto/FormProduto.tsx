...
function FormProduto() {
    ...
    return (
        <div className="container flex flex-col items-center justify-center mx-auto px-2 p-20 md:pt-4 md:pb-8 ">
            <h1 className="text-3xl text-violet-950 md:text-4xl text-center text-whitemy-8">
            ...
            >
                <div className="flex flex-col gap-2 text-violet-950 font-medium ">
                    ...
                    <input
                        ...
                        name="nome"
                        required
                        className="bg-white/30 border-2 border-teal-600 rounded p-2 bg-white text-base md:text-lg"
                    />
                </div>
                ...
                <div className="flex flex-col gap-2 text-violet-950 font-medium">
                    ...
                    <select
                        name="categoria"
                        id="categoria"
                        className="p-2 bg-white/30 border-2 rounded border-teal-600"
                ...
                <button
                    className="rounded text-slate-100 font-medium bg-teal-400 hover:bg-teal-500 
